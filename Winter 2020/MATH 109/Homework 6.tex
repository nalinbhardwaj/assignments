	...
	\begin{enumerate}[(a)]
		...
		\item Since at $1^3 = 1 = \frac{1^2(1+1)^2}{4}$, the formula holds true for $n = 1$.
			...
			\begin{eqnarray*}
				...
				1^3+2^3 +\cdots+ k^3 + (k+1)^3 = \frac{k^2(k+1)^2 + 4(k+1)^3}{4} \\
				1^3+2^3 +\cdots+ k^3 + (k+1)^3 = \frac{(k+1)^2(k^2+4k+4)}{4} \\
...
\section{Problem 6.10}
	...
	Since $a = \frac{a(1-r)}{1-r}$, the formula holds true for $n = 1$.
...
\section{Problem 6.12}
	\begin{enumerate}[(a)]
		...
		Therefore, $P(k+1)$ is true. $P(k) \implies P(k+1)$.
		
		\item $P(1): 9 = \frac{19}{2}$ is false. Therefore, $\forall n \in \mathbb{N}, P(n)$ is false.
	\end{enumerate}
...
\section{Problem 6.34}
	...
	Hence, by the strong principle of mathematical induction, $a_n = 2^n$ for all $n \in \mathbb{N}$.
...
\section{Problem 6.37}
	...
	Then $k+1 = (k-2) + 3$. Let $k-2 = 3x_{k-2}+7y_{k-2}$ for some $x_{k-2}, y_{k-2} \in \mathbb{Z^+}+\{0\}$. Therefore, $k+1 = 3(x_{k-2}+1)+7y_{k-2}$. Since $x_{k-2}+1 and y_{k-2} \in \mathbb{Z^+}+\{0\}$, by the strong principle of mathematical induction, all $n \geq 12$ can be represented as $n = 3a+7b$ for some $a, b \in \mathbb{Z^+}+\{0\}$.
